...
model = dict(
    ...
    vision_encoder=dict(
        ...
        pretrained='/home/juntao/Models/OpenGVLab/InternVideo2-Stage2_1B-224p-f4/InternVideo2-stage2_1b-224p-f4.pt',
        use_checkpoint=True,
        checkpoint_num=40,
...
auto_resume = True
jump_evaluate = False
pretrained_path = "/home/juntao/Models/OpenGVLab/InternVideo2-Stage2_1B-224p-f4/InternVideo2-stage2_1b-224p-f4.pt"
# pretrained_path = ""
