...
model = dict(
    ...
    from_pretrained="/home/juntao/Models/hpcai-tech/OpenSora-STDiT-v3",
    qk_norm=True,
...
vae = dict(
    ...
    from_pretrained="/home/juntao/Models/hpcai-tech/OpenSora-VAE-v1.2",
    micro_frame_size=17,
    micro_batch_size=4,
)
text_encoder = dict(
    ...
    from_pretrained="/home/juntao/Models/DeepFloyd/t5-v1_1-xxl",
