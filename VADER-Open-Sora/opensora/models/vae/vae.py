...
class VideoAutoencoderKL(nn.Module):
    def __init__(
        self, from_pretrained=None, micro_batch_size=None, cache_dir=None, local_files_only=True, subfolder=None
    ):
        super().__init__()
...
class VideoAutoencoderKLTemporalDecoder(nn.Module):
    def __init__(self, from_pretrained=None, cache_dir=None, local_files_only=True):
        super().__init__()
...
class VideoAutoencoderPipeline(PreTrainedModel):
    ...
    def __init__(self, config: VideoAutoencoderPipelineConfig):
        ...
        config.vae_2d = { #TODO: Unelegant fixed writing may cause problems in other models
            "from_pretrained": "/home/juntao/Models/PixArt-alpha/pixart_sigma_sdxlvae_T5_diffusers",
...
def OpenSoraVAE_V1_2(
    ...
    vae_2d = dict(
        type="AutoencoderKL",
        # type="VideoAutoencoderKL",
        from_pretrained="/home/juntao/Models/PixArt-alpha/pixart_sigma_sdxlvae_T5_diffusers", # "PixArt-alpha/pixart_sigma_sdxlvae_T5_diffusers",
        subfolder="vae",
    ...
    if from_pretrained is not None and os.path.isdir(from_pretrained):
